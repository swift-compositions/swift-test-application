...
//
// Note: Test is NOT @_exported here.
...
// String.String (via the Kernel → Kernel →
// String @_exported chain), which shadows Swift.String in
// SwiftPM's auto-generated test runner.
// Re-export Layer 4 (runner infrastructure) for convenience
...
// Time molecule for Benchmark/Duration types
